...
/**
 * {@code GPIO_CONFIGURE.MODE} (doc/PROTOCOL.md §15.1). Mirrors firmware's
 * {@code Protocol.h} {@code gpioMode} namespace.
 */
public final class GpioMode {
	...
	/**
	 * Reserved, not implemented by firmware yet - a GPIO_CONFIGURE using this MODE
	 * gets NACK(BAD_PARAMETERS).
	 */
